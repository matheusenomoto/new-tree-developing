...
function Home() {
    ...
    return (
        <div class='main-home'>
            ...
            <div class='single-introduction'>
                <img src={businessdevelopmentsolutions} />
                <div class='single-introduction-text'>
                    <p>Escolha o que deseja melhorar e nos permita ajudá-lo através da tecnologia que podemos entregar a você.</p>
                    <p>Entre em <a href="/contact">contato</a> com a <a href="/contact">tree developing</a> para que a gente ajude suas ideias serem transformadas em verdadeiras estratégias vencedoras.</p>
                </div>
            </div>
